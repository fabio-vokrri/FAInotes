...
\begin{itemize}
    ...
    \item [\(\wedge\)] is called \textbf{conjunction}. Its parts are \textbf{conjuncts}.
    \item [\(\vee\)] is called \textbf{disjunction}. Its parts are \textbf{disjuncts}.
...
\begin{itemize}
    ...
    \item \(P \wedge Q\) is true iff both \(P\) and \(Q\) are both true in \(m\).
    \item \(P\vee Q\) is true iff either \(P\) or \(Q\) is true in \(m\).
...
\begin{table}[h]
    ...
    \begin{tabular}{c|c||c|c|c|c|c}
        \(P\) & \(Q\) & \(\neg P\) & \(P \wedge Q\) & \(P\vee Q\) & \(P\Rightarrow Q\) & \(P \Leftrightarrow Q\) \\ \hline\hline
        0 & 0 & 1 & 0 & 0 & 1 & 1 \\ \hline
        0 & 1 & 1 & 0 & 1 & 1 & 0 \\ \hline
        1 & 0 & 0 & 0 & 1 & 0 & 0 \\ \hline
        1 & 1 & 0 & 1 & 1 & 1 & 1
...
\begin{itemize}
    ...
    \item [\(\exists\)] - \textbf{existential quantifiers}. The sentence \(\exists x P\) says that \textit{P} is true for at least one object \textit{x}. Just like \(\Rightarrow\) is the natural connective to use with the universal quantifier, \(\wedge\) is the natural connective to use with \(\exists\).
\end{itemize}
